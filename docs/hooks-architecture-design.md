...
│   - Resources: workflow state, journal  │
│   - Tools: hooks, checkpoints, policy   │
│   - Prompts: workflow guides            │
└──────────────┬──────────────────────────┘
               │ IPC (JSON)
┌──────────────▼──────────────────────────┐
│   seeyue-workflows (Node.js Runtime)    │
│   - Hooks System                        │
│   - Workflow Engine                     │
│   - Policy Engine                       │
└─────────────────────────────────────────┘
...
**END OF DOCUMENT - hooks-architecture-design.md**